...
LAYOUT_V_COMPARISON_ICON = get_icon_path("layout_v_comparison.png")
LAYOUT_H_COMPARISON_ICON = get_icon_path("layout_h_comparison.png")
LAYOUT_V_SXS_ICON = get_icon_path("layout_v_sxs.png")
LAYOUT_H_SXS_ICON = get_icon_path("layout_h_sxs.png")